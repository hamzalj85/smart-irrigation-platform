...
Write-Host "1/4  Arret de spark et du bridge..." -ForegroundColor Cyan
docker compose stop spark-streaming bridge | Out-Null
docker compose rm -f spark-streaming bridge | Out-Null
...
docker volume rm smart-irrigation-platform_spark_checkpoints 2>$null | Out-Null
